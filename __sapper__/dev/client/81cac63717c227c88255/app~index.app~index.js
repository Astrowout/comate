...
function add_css() {
	...
	style.textContent = ".root.svelte-om7t7g{display:flex;flex-direction:column;justify-content:space-between;align-items:center;margin:0 auto;padding:15px 20px 50px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(span0, file, 18, 3, 305);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(span1, "class", "maker");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(span1, file, 18, 26, 328);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(p, "class", "song");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(p, file, 17, 2, 285);
		},
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = !paused && create_if_block(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(track, file, 26, 2, 422);
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(audio_1, file, 22, 1, 379);
		...
		p: function update(ctx, [dirty]) {
			if (!paused) if_block.p(ctx, dirty);
